...
namespace MauiAppMinhasCompras.Views
{
    public partial class EditarProduto : ContentPage
    {
        ...
        public EditarProduto(Produto p)
        {
            ...
            txt_categoria.Text = _produto.Categoria;
        ...
        private async void btn_salvar_Clicked(object sender, EventArgs e)
        {
            try // Tenta converter os valores e atualizar o produto
            {
                ...
                {
                    await DisplayAlert("Erro", "Quantidade deve ser um número.", "OK");
                    return;
                }
                ...
                {
                    await DisplayAlert("Erro", "Preço deve ser um número.", "OK");
                    return;
                }
                ...
                _produto.Categoria = txt_categoria.Text;
